...
- (id)initWithCoordinate:(ARGeoCoordinate *)coordinate delegate:(id<MarkerViewDelegate>)delegate
{
	if((self = [super initWithFrame:CGRectMake(0.0f, 0.0f, kWidth, kHeight)]))
    {
        ...
        UIImageView * imgView = [[UIImageView alloc]initWithFrame:CGRectMake(0.0f, 0.0f, 100, 100)];
        imgView.image = [UIImage imageNamed:@"Annotation.png"];
        ...
        [self bringSubviewToFront:_lblDistance];
